...
public class AplicationController {
    ...
    private int inputYearOfBirthday() {
        int yearOfBirthday;
        while (true) {
            System.out.println("Input year of birthday");
            try {
                ...
                System.out.println("Wrong input data of birthday ");
            }
        }
    ...
    private int inputMonthOfBirthday() {
        int monthOfBirthday;
        while (true) {
            System.out.println("Input month of birthday");
            try {
    ...
    private int inputDayOfBirthday() {
        int dayOfBirthday;
        while (true) {
            System.out.println("Input day of birthday ");
            try {
